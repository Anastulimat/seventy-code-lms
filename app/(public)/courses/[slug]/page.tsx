    ...
    return (
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 mt-5">
                    ...
                    <div className="space-y-4">
                        {course.chapter.map((chapter, index) => (
                            <Collapsible key={chapter.id} defaultOpen={index === 0}>
                                <Card
                                    className="p-0 gap-0 overflow-hidden border-2 transition-all duration-200 hover:shadow-md"
                                >
                                    <CollapsibleTrigger>
                                        <div>
                                            <CardContent className="p-6 hover:bg-muted/50 transition-colors">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-4">
                                                        <p className="flex size-10 items-center rounded-full bg-primary/10 text-primary justify-center font-semibold">
                                                            {index + 1}
                                                        </p>
                                                        <div>
            ...
            <div className="order-2 lg:col-span-1">
                <div className="sticky top-20 bg-background rounded-xl shadow-lg">
                            ...
                            <div className="mb-6 space-y-3">
                                ...
                                <ul className="space-y-2">
                                    <li className="flex items-center gap-2">
                                        <div className="rounded-full bg-green-500/10 text-gray-500 p-1">
